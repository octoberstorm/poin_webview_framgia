...
$('.page__paragraph').html($('.page__paragraph').html().replace(exp,"<a href='$1' target='_blank'>$1</a>"));
...
$(document).ready(function(){
	...
	if($('.page--photo__num').is(":contains('-')")){
		$('.page--photo__feeling').addClass('feeling__bad').removeClass('feeling__good');
	} else {
		return false;
	}
...
// 
// Add keyboard shortcut for prev & next page.
// 
$(document).ready(function () {
